...
def operator_label_replacement(name: str, label: str):
    custom_label = os.getenv(f"BRE_{name.upper()}_LABEL")
...
def export_rule_data(variables, actions):
    ...
    - variable_type_operators: a dictionary of all field_types -> list of
    available operators
    """
