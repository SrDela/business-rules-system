...
from business_rules.variables import (
    BaseVariables, string_rule_variable, numeric_rule_variable,
...
class IntegrationTests(TestCase):
    ...
    def test_check_incorrect_operator_name(self):
        condition = {
            'name': 'foo', 'operator': 'equal_tooooze', 'value': 'foo'
        }
        ...
        self.assertEqual(all_data.get("actions"), [
            {
                ...
                "label": "Some Action",
                "params": [{
                    'fieldType': 'numeric', 'label': 'Foo', 'name': 'foo'
                }]
            },
            {
                ...
                "label": "woohoo",
                "params": [{
                    'fieldType': 'text', 'label': 'Bar', 'name': 'bar'
                    }]
            },
            {
    ...
    def test_export_rule_data_operator_label_replacement(self):

        os.environ["BRE_IS_FALSE_LABEL"] = "Es Falso"
        os.environ["BRE_IS_TRUE_LABEL"] = "Es Verdadero"
        os.environ["BRE_EQUAL_TO_LABEL"] = "Igual a"
        os.environ["BRE_GREATER_THAN_LABEL"] = "Mayor que"
        os.environ["BRE_GREATER_THAN_OR_EQUAL_TO_LABEL"] = "Mayor o igual a"
        os.environ["BRE_LESS_THAN_LABEL"] = "Menor o igual a"
        os.environ["BRE_LESS_THAN_OR_EQUAL_TO_LABEL"] = "Menor o igual a"
        ...
        self.assertEqual(all_data.get("variable_type_operators"), {
            'boolean': [
                {
                    'input_type': 'none',
                    'label': os.getenv("BRE_IS_FALSE_LABEL"),
                    'name': 'is_false'
                },
                {
                    'input_type': 'none',
                    'label': os.getenv("BRE_IS_TRUE_LABEL"),
                    'name': 'is_true'
                }
            ],
            'numeric': [
                {
                    'input_type': 'numeric',
                    'label': os.getenv("BRE_EQUAL_TO_LABEL"),
                    'name': 'equal_to'
                },
                {
                    'input_type': 'numeric',
                    'label': os.getenv("BRE_GREATER_THAN_LABEL"),
                    'name': 'greater_than'
                },
                {
                    'input_type': 'numeric',
                    'label': os.getenv("BRE_GREATER_THAN_OR_EQUAL_TO_LABEL"),
                    'name': 'greater_than_or_equal_to'
                },
                {
                    'input_type': 'numeric',
                    'label': os.getenv("BRE_LESS_THAN_LABEL"),
                    'name': 'less_than'
                },
                {
                    'input_type': 'numeric',
                    'label': os.getenv("BRE_LESS_THAN_OR_EQUAL_TO_LABEL"),
                    'name': 'less_than_or_equal_to'
                }
            ],
            'select': [
